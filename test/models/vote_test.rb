...
describe Vote do
  ...
  describe "validations" do
    let (:user1) { User.new(username: 'chris', email: 'fake@gmail.com', uid: 101020304, provider: 'github') }
    let (:user2) { User.new(username: 'chris', email: 'fake@yahoo.com', uid: 403020101, provider: 'github') }
