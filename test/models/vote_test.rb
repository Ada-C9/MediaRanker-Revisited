...
describe Vote do
  ...
  describe "validations" do
    let (:user1) { User.new(username: 'chris', uid: 1337, provider: 'github', email: 'chris@nowhere.com') }
    let (:user2) { User.new(username: 'chris', uid: 13371337, provider: 'github', email: 'chris@elsewhere.com') }
