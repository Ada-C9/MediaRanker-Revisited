...
describe Vote do
  ...
  describe "validations" do
    let (:user1) { User.new(username: 'chris', email: "test@ada.com", uid: "124", provider: "github") }
    let (:user2) { User.new(username: 'chris', email: "test@ada.com",
    uid: "124", provider: "github") }
