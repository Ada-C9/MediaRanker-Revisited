...
describe Vote do
  ...
  describe "validations" do
    let (:user1) { User.new(name: 'chris', uid: 201802018, email: 'angela@ada.com', provider: 'github') }
    let (:user2) { User.new(name: 'chris', uid: 201802018, email: 'angela@ada.com', provider: 'github') }
