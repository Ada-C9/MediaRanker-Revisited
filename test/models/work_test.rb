...
describe Work do
  ...
  describe "vote_count" do
    ...
    it "tracks the number of votes" do
      work = Work.create!(title: "test title", category: "movie")
      4.times do |i|
        user = User.create!(name: "user#{i}", uid: 201802018, email: 'angela@ada.com', provider: 'github' )
  ...
  describe "top_ten" do
    before do
      ...
      test_users = []
      20.times do |i|
        test_users << User.create!(name: "user#{i}", uid: 201802018, email: 'angela@ada.com', provider: 'github')
      end
