...
describe Work do
  ...
  describe "vote_count" do
    ...
    it "tracks the number of votes" do
      work = Work.create!(title: "test title", category: "movie")
      4.times do |i|
        user = User.create!(username: "user#{i}", email: "fake@gmail.com", uid: rand(100..1000), provider: "github")
  ...
  describe "top_ten" do
    before do
      ...
      test_users = []
      20.times do |i|
        test_users << User.create!(username: "user#{i}", email: "fake@gmail.com", uid: rand(100..1000), provider: "github")
      end
