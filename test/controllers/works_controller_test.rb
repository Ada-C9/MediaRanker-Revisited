...
describe WorksController do
  ...
  describe "guest user" do
    it "rejects request for new work form" do

    end
    it "rejects request to create a work" do

    end
    it "rejects request for the edit form" do
      get edit_work_path(Work.first)
      must_respond_with :unauthorized
    end
    it "rejects request for update a work" do

    end
    it "rejects request to destroy a work" do
